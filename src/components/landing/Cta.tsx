        ...
        <section id='cta' className={`flex bg-foreground-50 md:min-h-[1000px] ${inView ? 'inline animate-fade animate-once animate-ease-in-out' : 'hidden'}`}>
            ...
            <section className='flex flex-col justify-center items-center gap-10 m-20 text-clip tracking-normal min-h-full'>
                ...
                { infoSent ?
                  ...
                  <section className={`w-full p-14 animate-fade animate-once animate-ease-in-out`}>
                    <p className='text-lg flex justify-center align-center text-center gap-5'>
                      <Check width={25} height={25}/>Recibimos tus datos, nos comunicaremos muy pronto
                    </p>
                  </section>
                  :
                  <React.Fragment>
                  ...
                  <Form data={formData}/>
                  <Button className='w-full' isDisabled={infoSent} color='primary' onClick={handleinfoSent}>Enviar</Button>
                    </React.Fragment>
                  }
            </section>
        </section>
