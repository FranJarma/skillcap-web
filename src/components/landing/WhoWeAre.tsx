      ...
      >
        <section className="flex flex-col gap-10 text-clip m-10 md:m-48">
          <h2 className="text-4xl lg:text-5xl !leading-snug font-bold">
            Somos <span className="bg-teal-700 text-white">Skillcap</span> la
            solución para tu rendimiento deportivo.
          </h2>
          <p className="text-xl lg:text-2xl text-foreground-600 text-justify antialiased">
            No solo nos enfocamos en tu desempeño en el campo, sino también en
            cómo te presentas ante el mundo. Queremos que tu imagen y la de tu
            equipo brillen tanto como tus habilidades. Somos jóvenes, amigables
            y siempre estamos a tu lado para ofrecerte el apoyo visual que
            necesitas.
          </p>
          <Button
