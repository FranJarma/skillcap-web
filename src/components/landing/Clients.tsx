...
export const Clients = () => {
  ...
  return (
    <div ref={ref}>
      <section id="clients" className={`flex flex-col ${inView ? 'inline animate-fade animate-once animate-ease-in-out' : 'hidden'} md:flex-row justify-between m-20`}>
        <section className='flex flex-col justify-center items-center gap-10 md:m-20'>
            <h2 className='text-3xl md:text-5xl font-bold text-center'>Nuestros clientes</h2>
            <Slider>
            {
              clients.map(client => (
                        ...
                        <section className="flex flex-col col-span-6 md:col-span-8">
                          <section className="flex justify-between items-start">
                            <section className="flex flex-col gap-5">
                              ...
                              <Skeleton isLoaded={isLoaded}>
                                <h3 className="font-semibold text-foreground/90 text-2xl">{client.name}</h3>
                              </Skeleton>
                              <Skeleton isLoaded={isLoaded}>
                                <hr className='w-6/12'/>
                              </Skeleton>
                              <Skeleton isLoaded={isLoaded}>
                                <p className="text-sm font-medium mt-2 text-justify">{client.address}</p>
                              </Skeleton>
                            </section>
                          </section>
                        </section>
